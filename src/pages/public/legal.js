...
const pages = {
  ...
  '/privacy': {
    ...
    sections: [
      ...
      ['Actividad comunitaria', 'Favoritos, reportes, bloqueos y notificaciones internas se guardan para ofrecer esas funciones y aplicar seguridad. Las notificaciones leídas se conservan hasta 90 días y ninguna notificación supera 180 días. El reinicio de recomendaciones elimina eventos, intereses e impresiones, pero no elimina anuncios, pagos ni favoritos.'],
