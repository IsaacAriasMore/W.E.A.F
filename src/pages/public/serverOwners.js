...
export function render() {
  return `<section class="owners-hero container"><a href="/servers" data-link>← Volver al directorio</a><div><p>Para dueños de servidores</p><h1>Publica con control y cobro transparente.</h1><span>Completa tu ficha, elige Normal o Plus y activa un mes mediante Stripe Checkout.</span></div></section><section class="owner-plans container" data-owner-plans>${plansMarkup(fallbackPlans)}</section><section class="owner-process container"><h2>Un flujo corto y transparente.</h2><ol><li><span>01</span><div><strong>Elige el alcance</strong><p>Normal para presencia estable; Plus para destacar.</p></div></li><li><span>02</span><div><strong>Completa la ficha</strong><p>Mapas, rates, mods, enlaces y banner quedan guardados como borrador.</p></div></li><li><span>03</span><div><strong>Confirma el pago</strong><p>Stripe procesa la suscripción y el webhook firmado activa la publicación.</p></div></li></ol><p class="owner-policy">Las publicaciones deben cumplir la <a href="/server-listing-policy" data-link>política de servidores</a>. El equipo puede pausar contenido engañoso o inseguro.</p></section>`;
}
