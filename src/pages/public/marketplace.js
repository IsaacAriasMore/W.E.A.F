...
function card(listing) {
  ...
  return `<article class="market-card ${listing.is_featured ? 'is-featured' : ''}" data-listing-card="${listing.id}">
    <a href="/marketplace/${escapeHtml(listing.slug)}" data-link aria-label="${escapeHtml(t('marketplace.view', { title: listing.title }))}">
