...
export function bind({ path, authService, navigate }) {
  ...
  Promise.all([service.getCatalog(), service.getMyWorkspace(), service.getSettings(), service.getRecommendationSettings()]).then(([catalog, workspace, settings, preferences]) => {
