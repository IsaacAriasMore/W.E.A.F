...
- Webhooks almacenados en Supabase Vault; la tabla de configuración conserva únicamente el identificador del secreto y sus últimos cuatro caracteres.
...
species -> breeds
species -> mutations
tribes -> propagator_alerts
tribes -> private.discord_deliveries
```
